...
\begin{figure}[h]
\centering
\includegraphics[scale=0.43]{\pathtopartone/graphics/wave_in_arbitrary_direction}
...
\begin{figure}[h]
\centering
\includegraphics[width=.7\linewidth]{\pathtopartone/graphics/phase_velocity_of_wave}
...
\begin{figure}[h]
\centering
\includegraphics[width=.8\linewidth]{\pathtopartone/graphics/img3}
