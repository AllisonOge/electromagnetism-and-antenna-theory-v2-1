...
\begin{figure}[h]
\centering
\includegraphics[width=.7\linewidth]{\pathtopartone/graphics/group30a}
...
\begin{figure}[h]
\centering
\includegraphics[width=.8\linewidth]{\pathtopartone/graphics/group30b}
...
\begin{figure}[h]
\centering
\includegraphics[width=.7\linewidth]{\pathtopartone/graphics/group30c}
...
\begin{figure}[h]
\centering
\includegraphics[width=.7\linewidth]{\pathtopartone/graphics/incident_and_reflected_waves}
...
\begin{figure}[h]
\centering
\includegraphics[width=.7\linewidth]{\pathtopartone/graphics/group30e}
\caption{Incident wave at a media interface}
\label{fig:group30e}
\end{figure}
...
\footnote{
\includegraphics[height=20mm]{\pathtopartone/graphics/snells} Willebrord Snellius, (1580 - 1626), Dutch mathematician and astronomer. In 1621, he formulated Snell's Law, foundational in optics, describing how light bends at the boundary of different mediums. This groundbreaking work revolutionized our understanding of light's behavior and remains fundamental in optics and various scientific fields.
}
...
\begin{figure}[h]
\centering
\includegraphics[width=.7\linewidth]{\pathtopartone/graphics/group30f}
