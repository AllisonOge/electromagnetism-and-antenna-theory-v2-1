...
\begin{figure}
	\centering
	\includegraphics[width=1\linewidth]{fig171}
...
\end{figure}
 ...
 \begin{figure}
 	\centering
 	\includegraphics[width=1\linewidth]{fig172}
...
\begin{figure}[htbp]
	...
	\centering
	\includegraphics[width=.4\linewidth]{fig173}
	\label{}
	\end{minipage}%
	\begin{minipage}{.25\textwidth}
	\centering
	\includegraphics[width=.4\linewidth]{fig173b}
	\label{}
	\end{minipage}
	\begin{minipage}{.5\textwidth}
	\centering
	\includegraphics[width=.4\linewidth]{fig173c}
	\label{}
\end{minipage}%
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{fig174}
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{fig175}
...
\begin{figure}[htbp]
	...
	\begin{minipage}{.25\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{fig176}
		\label{}
	\end{minipage}%
	\begin{minipage}{.25\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{fig176b}
		\label{}
	\end{minipage}
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{fig176c}
		\label{}
	\end{minipage}%
...
\begin{figure}[htbp]
	...
	\begin{minipage}{.25\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{fig177}
		\label{}
	\end{minipage}%
	\begin{minipage}{.25\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{fig177b}
		\label{}
	\end{minipage}
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{fig177c}
		\label{}
	\end{minipage}%
...
\begin{figure}[htbp]
	...
	\begin{minipage}{.25\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{fig178b}
		\label{}
	\end{minipage}%
	\begin{minipage}{.25\textwidth}
		\centering
		\includegraphics[width=.4\linewidth]{fig178a}
		\label{}
	\end{minipage}
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{fig178}
	\caption{Isotrophic and Anisotrophic Medium}
