...
\item To explain the different types of \index{coordinate systems}coordinate systems, such as Cartesian, cylindrical, spherical, and others, and their properties, such as origin, axes, unit vectors\index{vectors}.
...
\item To apply the basic \index{coordinate system} coordinate system operations to solve problems in electromagnetism.
