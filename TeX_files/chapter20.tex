\chapter{Boundary conditions.}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=1\linewidth]{diemedium1}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=1\linewidth]{diemedium2}
	...
	Any general displacement vector in medium 1 close to the interface can be resolved into two components, the tangential $D_{t1}$ and normal components $D_{n1}$. 
		\begin{figure}[h]
		\centering
		\includegraphics[width=1\linewidth]{diemedium3}
	...
	If we take a loop around the boundary
		\begin{figure}[h]
		\centering
		\includegraphics[width=1\linewidth]{diemedium4}
	...
	\end{figure}
	 ...
	 \end{align*}
	  ...
	  \begin{figure}[h]
	  	\centering
	  	\includegraphics[width=1\linewidth]{diemedium4_2}
	  ...
	  \begin{figure}[h]
	  	\centering
	  	\includegraphics[width=1\linewidth]{diemedium4_2_2}
  ...
  When we have a medium on both sides of a dielectric.
      \begin{figure}[h]
      	\centering
      	\includegraphics[width=1\linewidth]{diemedium5}
  ...
  \begin{figure}[h]
  	\centering
  	\includegraphics[width=1\linewidth]{diemedium5_2}
  ...
  Similarly, it is possible that when we have time varying fields, there might be current flowing across the surface of the conductor. Therefore, for an ideal conductor the field inside it is zero, but we can have surface charges and surface current. The situation is as we have it in the figure below.
	  \begin{figure}[h]
	  	\centering
	  	\includegraphics[width=1\linewidth]{diemedium5_2_2}
	  	\caption{Dielectric - Conductor Interface.}
	  \end{figure}
  ...
  \begin{exmp}
  	...
  	\begin{figure}[h]
  		\centering
  		\includegraphics[width=1\linewidth]{fig2010}
  ...
  \begin{exmp}
  	...
  	\begin{figure}[h]
  		\centering
  		\includegraphics[width=1\linewidth]{diemedium7}
