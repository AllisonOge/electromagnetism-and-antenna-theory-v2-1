...
\begin{figure}[h]
\centering
\includegraphics[height=5cm]{\pathtopartone/graphics/Poinccare}
...
\begin{figure}[h]
\centering
\includegraphics[height=5cm]{\pathtopartone/graphics/sphere}
\caption{longitude 2$\epsilon$ and latitude 2$\tau$}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[height=5cm]{\pathtopartone/graphics/SPHERE001}
...
\begin{figure}[h]
\centering
\includegraphics[height=5cm]{"\pathtopartone/graphics/axial ratio"}
...
\begin{figure}[h]
\centering
\includegraphics[width=.7\linewidth]{\pathtopartone/graphics/interact}
...
\begin{figure}[h]
\centering
\includegraphics[height=5cm]{"\pathtopartone/graphics/linear polarized"}
...
\begin{figure}[h]
\centering
\includegraphics[height=5cm]{"\pathtopartone/graphics/orthogonal polarized wave"}
...
\begin{figure}
\centering
\includegraphics[width=0.7\linewidth]{\pathtopartone/graphics/power}
