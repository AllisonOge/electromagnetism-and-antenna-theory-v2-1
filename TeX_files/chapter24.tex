...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\linewidth]{\pathtopartone/graphics/sphere}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\linewidth]{\pathtopartone/graphics/orthogonal_states}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{\pathtopartone/graphics/generatingEP}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{\pathtopartone/graphics/power}
