...
\begin{figure}[ht]
	\centering
	\includegraphics[width=1\linewidth]{\pathtopartone/graphics/inductorhighfreq}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.5]{\pathtopartone/graphics/Capacitivebehaviorathighfrequency}
	\caption{Graph showing the Variation of Inductive reactance with frequency}
	\label{fig:Capacitivebehaviorathighfrequency}
\end{figure}

Similarly, suppose we take a capacitor at a low frequency, it will exhibit its ideal characteristics. As the frequency increases, the connecting leads or wires which have inductance starts to predominate beyond certain frequencies, and the capacitor no longer exhibit its ideal characteristics (see figure~\ref{fig:lowthenhighfrequency}).
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.3]{\pathtopartone/graphics/capacitorVariation}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.4]{\pathtopartone/graphics/group10diagram7}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.4]{\pathtopartone/graphics/group10diagram8}
...
% \begin{figure}[ht]
%	 \centering
%	 \includegraphics[width=0.8\linewidth]{\pathtopartone/graphics/group10diagram13}
%	 \caption{}
