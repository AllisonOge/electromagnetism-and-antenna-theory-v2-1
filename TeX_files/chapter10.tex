...
\begin{figure}[ht]
	\centering
	\includegraphics[width=1\linewidth]{graphics/inductorhighfreq}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.5]{graphics/Capacitivebehaviorathighfrequency}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=1\linewidth]{graphics/lowthenhighfrequency}
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.3]{graphics/capacitorVariation}
