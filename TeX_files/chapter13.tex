\chapter{Lossy Transmission Line}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\linewidth]{"Standing wave"}
...
Let us examine the effect of a lossy line on the reflection coefficient of the transmission line.
  ...
  \begin{figure}[h]
  	\centering
  	\includegraphics[width=1\linewidth]{"Smith chart lossy line"}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\linewidth]{"Short circuit load"}
