...
\begin{figure}[h]
\centering
%\includegraphics[width=1\linewidth]{\pathtopartone/graphics/fig194}
...
\begin{figure}[h]
\centering
\includegraphics[width=.5\linewidth]{\pathtopartone/graphics/problem3b}
\caption{Loop at y=1}
\end{figure} 
