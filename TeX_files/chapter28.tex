...
\begin{figure}[h]
\centering
\textsc{\includegraphics[width=1\linewidth]{\pathtopartone/graphics/surface_current_direction}}
...
\begin{figure}
\centering
\textsc{\includegraphics[scale=0.35]{\pathtopartone/graphics/slab_parallel_to_conducting_surface}}
...
\begin{figure}
\centering
\textsc{\includegraphics[width=0.9\linewidth]{\pathtopartone/graphics/power_flow}}
