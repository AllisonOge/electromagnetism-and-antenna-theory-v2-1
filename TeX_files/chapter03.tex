...
\includegraphics[scale=0.2]{euler}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale = 0.45]{VversusXcurve}
...
If $\alpha$ = 1(Nepers/meter)\footnote{
	\includegraphics[scale=0.2]{johnnapier2}
...
\begin{exmp}
	...
	\footnotetext[3]{
		\includegraphics[scale=0.3]{demoivre}
...
\begin{exmp}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=1\linewidth]{TL}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[scale=0.5]{VversusX}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.45]{tlcircuit}
