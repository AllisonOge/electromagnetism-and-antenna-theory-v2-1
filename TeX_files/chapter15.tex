\chapter{Graphical Approach To Analyzing Transmission Line Problems Using Smith Chart.}
...
\section{Problem using quarter wave transformer.}
 ...
 \begin{figure}[h]
	\centering
	\includegraphics[width=1\linewidth]{fighalfwave}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\linewidth]{tosin}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{fig14}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\linewidth]{coaxialcable1}
	\caption{COAXIAL LINE}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.8]{coaxialcable}
	\caption{COAXIAL LINE}
\end{figure}\\
...
$\epsilon_r$=1 air is the dielectric separation so that \\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\linewidth]{microstrip}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\linewidth]{ground}
	\caption{microstrip line}
\end{figure}
...
The other two structures are called unbalanced structure and the parallel wire transmission line is called a \textbf{balanced structure}.\\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\linewidth]{balun}
	\caption{TYPICAL DIAGRAM OF A BALUN}
\end{figure}

\begin{figure}[h]
	\centering
	\includegraphics[width=1\linewidth]{balun2}
	\caption{TYPICAL DIAGRAM OF A BALUN}
\end{figure}
...
we saw how these structure can be connected and lastly the use of a BALUN.\\
