...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{\pathtopartone/graphics/cylindricalspehere}
\caption{coaxial line}
\label{fig:coaxialcable1}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[scale=0.8]{\pathtopartone/graphics/coaxialcable}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{\pathtopartone/graphics/microStripLineStructure}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{\pathtopartone/graphics/variableMicroStripLineStructure}
