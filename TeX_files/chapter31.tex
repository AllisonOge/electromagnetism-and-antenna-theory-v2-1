...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{\pathtopartone/graphics/reflection_refraction1}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{\pathtopartone/graphics/perpendicular_polarization1}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.44]{\pathtopartone/graphics/perpendicular_polarization2}
\caption{}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.2\linewidth]{\pathtopartone/graphics/perpendicular_polarization3}
\caption{}
\label{fig:14}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=1.2\linewidth]{\pathtopartone/graphics/parallel_polarization1}
\caption{}
\label{fig:15}
\end{figure}
\begin{equation}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.6]{\pathtopartone/graphics/normal_incidence1}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{\pathtopartone/graphics/17}
\caption{}
\label{fig:17}
\end{figure}
