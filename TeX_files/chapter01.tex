...
\begin{enumerate}[(i)]
% \item Antennas and the different types of antennas and their characteristics, such as radiation patterns, gain, and impedance.
...
\subsubsection{Limitations of Coaxial cables}
\begin{enumerate}[(i)]
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.2]{\pathtopartone/graphics/adaptive_arrays}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{\pathtopartone/graphics/satellite}
...
\begin{figure}[h]
\centering
\includegraphics[width=1\linewidth]{\pathtopartone/graphics/634771461726914062}
...
% \Exercise[label={ex23}]
% When it comes to interferometric synthetic aperture radar (SAR) techniques, what challenges do we face inaccurately measuring ground deformation and how can we overcome them?
