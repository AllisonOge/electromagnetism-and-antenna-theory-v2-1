...
\textbf{Adaptive array\index{adaptive array antenna}:} steers the beam in the direction of the user/observer while simultaneously nulling interfering signals (see figure~\ref{fig:fh06_02}).
\begin{figure}[h]
\centering
...
\Question What is the difference between adaptive arrays and switched beam antenna?

\Question What is Swath width in SLAR?

\Question  Explain the concept of fading in cellular communication.

\Question If from 30MHz to 300MHz, the co-axial cable is used, and from 30GHz to 300GHz, the waveguide is used, what kind of transmission lines are used in the spectrum ranging from 300MHz to 30GHz?

\Question For a SLAR with the following characteristics: $\lambda = 1cm$, $L = 3m$, $H = 6000m$,
