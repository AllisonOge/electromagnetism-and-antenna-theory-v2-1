...
\section*{QUESTIONS}
\begin{enumerate}
	\item What is the difference between adaptive arrays and switched beam antenna?
	
	\item What is Swath width in SLAR?
	
	\item  Explain the concept of fading in cellular communication.
	
	\item If from 30MHz to 300MHz, the co-axial cable is used, and from 30GHz to 300GHz, the waveguide is used, what kind of transmission lines are used in the spectrum ranging from 300MHz to 30GHz?
	
	\item For a SLAR with the following characteristics: $\lambda = 1cm$, $L = 3m$, $H = 6000m$,
