...
In this chapter, we will discuss how to identify the types of load from standing wave pattern.\\
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.4]{Group91}
	\caption{A Smith chart representation of Inductive Load}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.4]{Group92}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.5]{Group93}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.5]{Group94}
...
If the load is neither capacitive nor inductive, then it must lie on the real horizontal axis of the smith chart. So the location of the load itself will be at either voltage minimum point or voltage maximum point.\\
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.5]{Group95}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.5]{Group96}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.5]{Group97}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.5]{Group98}
