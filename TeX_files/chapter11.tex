...
\end{dmath}}
Where $\frac{1}{2}CV_{o}^{2}\left[\frac{\lambda_{o}}{8}\right] $ is the energy stored in line capacitance and $ \frac{1}{2}L\frac{V_{o}^{2}}{Z_0^{2}}\left[ \frac{\lambda_{o}}{8} \right] $ is the energy stored in line inductance.
