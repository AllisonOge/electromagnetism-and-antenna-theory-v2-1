...
\begin{figure}[h]
\centering
\includegraphics[scale=0.5]{\pathtopartone/graphics/ShortcircuitTransmissionLine2}
% \caption{Voltage and Current distribution of the short-circuited transmission line}
\label{fig:ShortcircuitTransmissionLine2}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[scale=0.2]{\pathtopartone/graphics/voltagedistribution}
% \caption{Voltage and Current distribution of the short-circuited transmission line}
\label{fig:voltagedistribution}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[scale=0.2]{\pathtopartone/graphics/currentdistribution}
\caption{Voltage and Current distribution of the short-circuited transmission line}
